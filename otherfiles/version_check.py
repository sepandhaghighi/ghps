...
README_ITEMS = [
    "[Version {0}](https://github.com/sepandhaghighi/ghps/archive/v{0}.zip)",
    "pip install ghps=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/sepandhaghighi/ghps/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/sepandhaghighi/ghps/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['GHPS_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- Ghps {0}"]
